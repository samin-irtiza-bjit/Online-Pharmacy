<div id="notif-modal">
    ...
    <div id="products-popup-order" style="margin-top: 15%;">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="material-button-main clear-all-btn" name="submit">Clear</button>
        </div>
    </div>
</div>
<div class="card-wrapper w-80" style="margin-top:80px;">
    <div class="card-style w-100" style="min-height: 80vh;">
        <div class="card-header">
            <ul>
                <li class="header-title">
                    <h3 style="float: left;color:#333;">Notifications</h3>
                </li>
                <li>
                    <a class="card-button clear-all-modal">Clear All</a>
                </li>
            </ul>
            <h5 style="margin-bottom: 25px; margin-top: 0;">View incoming messages from PharmEasy</h5>
        </div>
        <div class="card-table">
            <table class="table-hover" style="color:#333;">
                ...
                <tr id="<?php echo $notif['n_id']; ?>" class="select-notif <?php if ($notif['n_status'] == 0) { ?>notif-unread<?php } ?>">
                    ...
                    <td class="w-60" style="">
                <?php 
                    if (strlen($notif['n_message']) > 80) {
                        echo substr($notif['n_message'], 0, 80) . "..";
                    } else {
                        echo $notif['n_message'];
                    } 
                ?>
                    </td>
                ...
                <div class="notif-empty">
                    ...
                    <h6>PharmEasy would notify you when you start ordering</h6>
                </div>
                <?php
                    }
                ?>
