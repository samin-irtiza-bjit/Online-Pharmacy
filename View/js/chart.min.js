                          ...
                          : ((f = -1 === u ? f : d[u]),
                            g.skip
                              ...
                              : (u !== c - 1
                                  ...
                                  : t(f, h),
                                (u = c)));
                    l || s.lineTo(d[d.length - 1]._view.x, r),
                  ...
                  for (
                    ...
                    (h = d[c]),
                      ...
                      0 === c
                        ...
                        : ((f = -1 === u ? f : d[u]),
                          g.skip ||
                            (u === c - 1 || o ? t(f, h) : s.moveTo(g.x, g.y),
                            (u = c)));
                  s.stroke(), s.restore();
                },
              }));
                ...
                o = t.Scale.extend({
                  ...
                  buildTicks: function () {
                    ...
                    if (
                      ...
                      0 !== y.diff(i.lastTick, i.tickUnit, !0) &&
                    ...
                    for (var k = 1; k <= i.scaleSizeInUnits; ++k) {
                      var S = x.clone().add(k, i.tickUnit);
                      if (
                        i.options.time.max &&
                        S.diff(i.lastTick, i.tickUnit, !0) >= 0
                      )
                        break;
                      k % i.unitScale === 0 && i.ticks.push(S);
                    }
