<div class="card-wrapper-sub profile-left-main-cont" style="color:black;">
    <div class="w-100">
        <div class="card-style w-100" style="margin-top:80px;">
            <div id="products-side-navi">
                ...
                <ul>
                    ...
                    <li class="dashboard-butt"><a id="notif-counter" href="index.php?mod=profile&view=notifications">Notifications <?php if ($user->get_notif_count($_SESSION['clientid'])) { echo "(" . $user->get_notif_count($_SESSION['clientid']) . ")"; } ?> </a> </li>
