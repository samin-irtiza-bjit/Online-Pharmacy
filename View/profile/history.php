<div class="card-wrapper profile-right-main-cont" style="margin-top:80px;">
    <div class="card-style w-100">
        <div id="products-right-content">
            <div class="card-header">
                <ul style="width: 50%;">
                    <li class="header-title">
                        <h3 style="float: left; color:#333;">Recent Orders</h3>
                    </li>
                    <li></li>
                </ul>
            ...
            <table class="table table-striped table-hover font-roboto" id="table-history">
                ...
                <tbody>
                    ...
                    <tr id="<?php echo $sli['order_id']; ?>" style="height: 48px;" class="product-link select-order" onclick="ohistory_show()">
                        ...
                        <td class="table_two_cont_profile">
                            <?php
                                $date = new DateTime($sli['order_date']);
