<div id="hiddenmenu3">
    <ul>
        ...
        <a href="index.php?mod=products&cat=all">
            <li>ALL</li>
        </a>
        <?php
        ...
        ?>
        <a class="action-link" href="index.php?mod=products&cat=<?php echo $values['cat_id']; ?>">
            <li><?php echo $values['cat_name']; ?></li>
        </a>
        <?php
            }
        ?>
...
<div class="card-wrapper-sub widt-change w-20" style="margin-top : 80px">
    <div id="hiddenmenu2">
...
<div class="card-wrapper-leftright notloginminimum w-80">
    <div class="card-style w-100" style="margin-top:80px;">
        <div id="products-info">
        <?php
            $c_info = $product->get_cat_info($_GET['cat']);
            foreach ($c_info as $c) {
        ?>
            <h3 style="font-weight: 400; font-family: 'Roboto', sans-serif; color:#333333;"><?php echo $c['cat_name']; ?></h3>
...
<div class="card-wrapper main-men">
    <div class="product-list-wrapper">
        <div id="products-right-header" class="bc-green fc-white" style="background-color:#58b072">
...
<div class="card-wrapper notloginall w-80">
    <div class="card-style w-100" style="text-align:center; margin-top:80px;">
        <svg id="loading-screen" class="spinner" width="40px" height="40px" viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg">
            <circle class="path" fill="none" stroke-width="6" stroke-linecap="round" cx="33" cy="33" r="30"></circle>
        </svg>
        <div id="products-right-content"></div>
...
<div class="card-wrapper w-80">
    <?php
        ...
        if ($_GET['cat'] != "all") {
            ?>
    <div class="card-style test-one w-100" style="text-align:center; margin-top:80px;">
        <svg id="loading-screen" class="spinner" width="40px" height="40px" viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg">
            <circle class="path" fill="none" stroke-width="6" stroke-linecap="round" cx="33" cy="33" r="30"></circle>
        </svg>
            ...
            $.ajax({
                ...
                success: function (data) {
                    setTimeout(function () {
                        ...
                        $("#popup-display-price").html("BDT " + data.pro_unit_price);
