...
?>
    ...
    <p class="step-desc" style="margin-bottom: 30px;">Your cart summary is displayed at the right side your screen where you can see the total number of items you ordered along wih the subtotal payment and total payment. Selection to what type of order you are going to go to is displayed which  you can choose Considered Sold.</p>
<?php
    }
    if (isset($_POST['step3'])) {
?>
    <h3 class="step-title">Delivery Process</h3>
    <p class="step-desc">Once your order has been confirmed, your items will be delivered as soon as possible within business days. Please do check if the products delivered has been damaged or has issues, BRACU Pharma will immediately investigate and take necessary action.</p>
