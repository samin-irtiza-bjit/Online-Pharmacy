...
?>
			<tr class="cart-tr">
				...
				<td class="ta-center bold">BDT <?php echo number_format ((float)$price, 2, '.', ',');?></td>
...
?>
        ...
        <div id="cart-summary">
            ...
            <table id="cart-summary-table">
                ...
                <tr>
                    <td>Subtotal</td>
                    <td class="ta-right">BDT <?php $sub = $product->get_cart_total($_SESSION['c_userid']); echo number_format((float) $sub, 2, '.', ','); ?></td>
                </tr>
            </table>
            <hr>
            ...
            <table id="cart-summary-total">
                <tr>
                    ...
                    <td class="bold fs-16 ta-right"><input type="hidden" name="total" value="<?php echo $product->get_cart_total($_SESSION['c_userid']); ?>">BDT
                    <?php echo number_format((float) $product->get_cart_total($_SESSION['c_userid']), 2, '.', ','); ?></td>
                </tr>
            </table>
<?php
